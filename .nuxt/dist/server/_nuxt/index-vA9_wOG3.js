  ...
  setup(__props) {
    ...
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Galerie d'images interactive - Projet pédagogique Master 1 Design d'interfaces Modifiée"
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="error-state" data-v-fe274fea><p data-v-fe274fea>❌ Erreur lors du chargement des images</p><button class="retry-button" data-v-fe274fea>Réessayer</button></div>`);
      } else {
        _push(ssrRenderComponent(_component_GalleryGrid, { images: images.value }, null, _parent));
      }
      _push(`</main><footer class="page-footer" data-v-fe274fea><p data-v-fe274fea> Propulsé par <a href="https://nuxt.com" target="_blank" rel="noopener" data-v-fe274fea>Nuxt 3</a>, <a href="https://supabase.com" target="_blank" rel="noopener" data-v-fe274fea>Supabase</a> &amp; <a href="https://vercel.com" target="_blank" rel="noopener" data-v-fe274fea>Vercel</a></p></footer></div>`);
    };
  }
});
...
//# sourceMappingURL=index-vA9_wOG3.js.map
