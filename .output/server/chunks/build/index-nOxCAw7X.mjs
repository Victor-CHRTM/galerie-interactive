  ...
  setup(__props) {
    ...
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Galerie d'images interactive - Projet p\xE9dagogique Master 1 Design d'interfaces"
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-page" }, _attrs))} data-v-8b2ef62a><header class="page-header" data-v-8b2ef62a><div class="header-content" data-v-8b2ef62a><h1 class="main-title" data-v-8b2ef62a>Galerie Interactive</h1><p class="subtitle" data-v-8b2ef62a> Projet p\xE9dagogique M1 - Design d&#39;interfaces interactives </p><p class="university" data-v-8b2ef62a>Universit\xE9 Paris 8</p>`);
      ...
      if (loading.value) {
        ...
        _push(`<div class="error-state" data-v-8b2ef62a><p data-v-8b2ef62a>\u274C Erreur lors du chargement des images</p><button class="retry-button" data-v-8b2ef62a> R\xE9essayer </button></div>`);
      } else {
        _push(ssrRenderComponent(_component_GalleryGrid, { images: images.value }, null, _parent));
      }
      _push(`</main><footer class="page-footer" data-v-8b2ef62a><p data-v-8b2ef62a> Propuls\xE9 par <a href="https://nuxt.com" target="_blank" rel="noopener" data-v-8b2ef62a>Nuxt 3</a>, <a href="https://supabase.com" target="_blank" rel="noopener" data-v-8b2ef62a>Supabase</a> &amp; <a href="https://vercel.com" target="_blank" rel="noopener" data-v-8b2ef62a>Vercel</a></p></footer></div>`);
    };
  }
});
...
//# sourceMappingURL=index-nOxCAw7X.mjs.map
